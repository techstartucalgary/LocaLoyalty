    ...
    return (
        <View className="pb-10">
                    ...
                    <View className="flex flex-1 justify-center items-center bg-black/75 ">
                        ...
                        >
                            <View className="w-full items-center">
                                ...
                                <Text className="text-lg font-medium text-[#153463]">{reward_name}</Text>
                                <Text className="text-lg italic font-semibold text-[#ACACAC]">{vendor_name}</Text>
            ...
            <TouchableOpacity onPress={() => setModalVisible(true)}>
                <View className="w-full rounded-md border border-black bg-white py-2 flex-row items-center" style={{ shadowOffset: { width: 0, height: 4 }, shadowColor: "#000000", shadowOpacity: 0.4, shadowRadius: 4, elevation: 20 }}>
                    <View className="px-8">
                        <Image source={{ uri: business_logo }} className="w-16 h-16 rounded-lg" style={{ resizeMode: "cover", backgroundColor: "#e1e4e8" }} />
                    </View>
