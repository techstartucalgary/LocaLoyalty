...
var migrator_1 = require("drizzle-orm/planetscale-serverless/migrator");
...
exports.db = (0, planetscale_serverless_1.drizzle)(connection, { schema: schema });
function main() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, migrator_1.migrate)(exports.db, { migrationsFolder: "drizzle-migrations" })];
                case 1:
                    _a.sent();
