...
const Coffee2Icon = ({ color, size }: { color: string; size: number }) => (
  ...
  >
    <path
      fill={color}
      fill-rule="evenodd"
      d="M3.284 11.266c-.133-2-.2-2.999.393-3.632C4.27 7 5.272 7 7.276 7h5.449c2.003 0 3.005 0 3.598.634c.162.173.275.374.35.616H17c2.526 0 4.75 1.812 4.75 4.25c0 2.438-2.224 4.25-4.75 4.25h-.65l-.035.5H3.685c-.02-.267-.038-.55-.058-.85zM16.45 15.25H17c1.892 0 3.25-1.322 3.25-2.75S18.892 9.75 17 9.75h-.2c-.012.43-.045.93-.084 1.516z"
      clip-rule="evenodd"
    />
    <path
      fill={color}
      d="M3.819 18.75h12.362c-.144 1.177-.378 1.917-.938 2.44c-.865.81-2.196.81-4.856.81h-.774c-2.66 0-3.99 0-4.856-.81c-.56-.523-.794-1.263-.938-2.44"
    />
    <path
      fill={color}
      fill-rule="evenodd"
...
const ChefHat2Icon = ({ color, size }: { color: string; size: number }) => (
  ...
  >
    <path
      fill={color}
      fill-rule="evenodd"
      d="M2 10a5 5 0 0 1 5.737-4.946a4.502 4.502 0 0 1 8.526 0A5 5 0 0 1 19 14.584v2.666H5v-2.666A5.001 5.001 0 0 1 2 10m9.043 3.67C10.165 13.024 9 11.984 9 11c0-1.673 1.65-2.297 3-1.005c1.35-1.292 3-.668 3 1.005c0 .985-1.165 2.025-2.043 2.67c-.42.307-.63.461-.957.461c-.328 0-.537-.154-.957-.462"
      clip-rule="evenodd"
    />
    <path
      fill={color}
...
const ShiningHeart2Icon = ({
  ...
  >
    ...
    <path
      fill={color}
      d="M7 11.06c0 2.542 2.01 3.897 3.48 5.11c.52.427 1.02.83 1.52.83s1-.403 1.52-.83c1.47-1.213 3.48-2.568 3.48-5.11c0-2.543-2.75-4.346-5-1.902c-2.25-2.444-5-.64-5 1.902"
    />
  </svg>
);
...
const Smile2Icon = ({ color, size }: { color: string; size: number }) => (
  ...
  >
    <path
      fill={color}
      fill-rule="evenodd"
      d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10m-3.603-6.447a.75.75 0 0 1 1.05-.155c.728.54 1.607.852 2.553.852s1.825-.313 2.553-.852a.75.75 0 1 1 .894 1.204A5.766 5.766 0 0 1 12 17.75a5.766 5.766 0 0 1-3.447-1.148a.75.75 0 0 1-.156-1.049M16 10.5c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5s.448-1.5 1-1.5s1 .672 1 1.5M9 12c.552 0 1-.672 1-1.5S9.552 9 9 9s-1 .672-1 1.5s.448 1.5 1 1.5"
      clip-rule="evenodd"
    />
  </svg>
);
