  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="relative">
        ...
        <div className="relative z-10 pt-10">
          <div className="flex flex-col items-center">
            <h1 className="text-black font-extrabold text-8xl">LOCALOYALTY</h1>
            <div className="flex items-center px-64">
              <Image src="/assets/Image1.png" alt="" width={474} height={352} />
      ...
      <div className="flex items-center justify-center px-10">
        <div className="px-24 bg-white z-40">
          <h1 className="font-bold text-4xl">Loyalty Programs</h1>
          <h1 className="font-bold text-4xl">Re-Invented</h1>
          <p className="font-normal text-3xl mt-4">
            ...
            physical stamp cards and white-label apps that they have to juggle.
          </p>
        </div>

        <Image src="/assets/Image2.png" alt="" width={474} height={352} />
      </div>

      <div className="flex items-center justify-center gap-24">
        <Image src="/assets/Image3.png" alt="" width={499} height={434} />
            ...
            <ul className="list-none font-semibold mt-2 space-y-4">
              <li>
                ...
                <p className="font-normal mx-10 mt-2">
                  Loyalty programs encourage customers to continue shopping with
                  a particular business to earn rewards, fostering long-term
                  relationships
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p className="font-normal mx-10 mt-2">
                  Through loyalty programs, businesses can collect valuable data
                  about customer preferences and purchasing behaviors, enabling
                  them to tailor marketing strategies more effectively
                </p>
              </li>
            </ul>
          </div>
      ...
      <div className="flex items-center justify-center gap-20 px-24 pt-10">
        ...
        <div>
          ...
          <p className="font-normal text-3xl pt-4">
            Easily create, customize, and launch your own loyalty platform to
            the LocaLoyalty mobile app for your customers to access
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <div>
          <h1 className="font-bold text-4xl">Improve Your Customer</h1>
          <h1 className="font-bold text-4xl">Retention Today!</h1>
